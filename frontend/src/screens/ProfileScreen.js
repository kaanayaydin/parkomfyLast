...
const ProfileScreen = ({ user, onEntrance }) => {
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.title}>Profil Bilgileri</Text>
      <TouchableOpacity style={styles.entranceBtn} onPress={onEntrance}>
        <Text style={styles.entranceBtnText}>🚗 Giriş Plaka Okuma (OCR)</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  entranceBtnText: { color: '#B2FF59', fontWeight: 'bold', fontSize: 15 },
});
