...
def _detect_parking_slots(image_bytes, camera_id=""):
    """
    Dinamik ROI + VP + yapısal ızgara (en uzun 2-3 çizgiyle hizalı). Occlusion: ızgara ile tahmini tamamlama.
    İsteğe bağlı: findContours+approxPolyDP semantik snap; EMA ile slot titreşim azaltma.
    """
